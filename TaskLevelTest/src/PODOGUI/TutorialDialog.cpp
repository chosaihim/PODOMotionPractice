...
void TutorialDialog::UpdateSomethings(){
    ...
    if(PODO_DATA.CoreData.EXF_R_Enabled){
    ...
    if(PODO_DATA.CoreData.EXF_L_Enabled){
    ...
    if(modiCnt < 20){
        ...
        ui->LE_MODI_R0->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_R_Modifier[0]));
        ui->LE_MODI_R1->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_R_Modifier[1]));
        ui->LE_MODI_R2->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_R_Modifier[2]));
        ui->LE_MODI_R3->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_R_Modifier[3]));
        ui->LE_MODI_R4->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_R_Modifier[4]));

        ui->LE_MODI_L0->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_L_Modifier[0]));
        ui->LE_MODI_L1->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_L_Modifier[1]));
        ui->LE_MODI_L2->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_L_Modifier[2]));
        ui->LE_MODI_L3->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_L_Modifier[3]));
        ui->LE_MODI_L4->setText(QString().sprintf("%.2f", PODO_DATA.CoreData.EXF_L_Modifier[4]));
