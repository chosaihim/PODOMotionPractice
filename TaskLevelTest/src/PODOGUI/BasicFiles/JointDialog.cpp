...
inline void DisplayJointReference(int jnum, QLineEdit *edit){
    edit->setText(QString().sprintf("%.3f", PODO_DATA.CoreData.ENCODER[MC_GetID(jnum)][MC_GetCH(jnum)].CurrentReference));
}
inline void DisplayJointEncoder(int jnum, QLineEdit *edit){
    edit->setText(QString().sprintf("%.3f", PODO_DATA.CoreData.ENCODER[MC_GetID(jnum)][MC_GetCH(jnum)].CurrentPosition));
}
...
void JointDialog::UpdateJoints(){
    ...
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RHY)][MC_GetCH(RHY)].b.GOV)  ui->LE_JOINT_RHY->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RHY->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RHR)][MC_GetCH(RHR)].b.GOV)  ui->LE_JOINT_RHR->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RHR->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RHP)][MC_GetCH(RHP)].b.GOV)  ui->LE_JOINT_RHP->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RHP->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RKN)][MC_GetCH(RKN)].b.GOV)  ui->LE_JOINT_RKN->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RKN->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RAP)][MC_GetCH(RAP)].b.GOV)  ui->LE_JOINT_RAP->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RAP->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RAR)][MC_GetCH(RAR)].b.GOV)  ui->LE_JOINT_RAR->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RAR->setStyleSheet("background-color: white");

    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LHY)][MC_GetCH(LHY)].b.GOV)  ui->LE_JOINT_LHY->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LHY->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LHR)][MC_GetCH(LHR)].b.GOV)  ui->LE_JOINT_LHR->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LHR->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LHP)][MC_GetCH(LHP)].b.GOV)  ui->LE_JOINT_LHP->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LHP->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LKN)][MC_GetCH(LKN)].b.GOV)  ui->LE_JOINT_LKN->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LKN->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LAP)][MC_GetCH(LAP)].b.GOV)  ui->LE_JOINT_LAP->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LAP->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LAR)][MC_GetCH(LAR)].b.GOV)  ui->LE_JOINT_LAR->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LAR->setStyleSheet("background-color: white");

    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RSP)][MC_GetCH(RSP)].b.GOV)  ui->LE_JOINT_RSP->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RSP->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RSR)][MC_GetCH(RSR)].b.GOV)  ui->LE_JOINT_RSR->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RSR->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RSY)][MC_GetCH(RSY)].b.GOV)  ui->LE_JOINT_RSY->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RSY->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(REB)][MC_GetCH(REB)].b.GOV)  ui->LE_JOINT_REB->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_REB->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RWY)][MC_GetCH(RWY)].b.GOV)  ui->LE_JOINT_RWY->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RWY->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RWP)][MC_GetCH(RWP)].b.GOV)  ui->LE_JOINT_RWP->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_RWP->setStyleSheet("background-color: white");

    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LSP)][MC_GetCH(LSP)].b.GOV)  ui->LE_JOINT_LSP->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LSP->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LSR)][MC_GetCH(LSR)].b.GOV)  ui->LE_JOINT_LSR->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LSR->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LSY)][MC_GetCH(LSY)].b.GOV)  ui->LE_JOINT_LSY->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LSY->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LEB)][MC_GetCH(LEB)].b.GOV)  ui->LE_JOINT_LEB->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LEB->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LWY)][MC_GetCH(LWY)].b.GOV)  ui->LE_JOINT_LWY->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LWY->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LWP)][MC_GetCH(LWP)].b.GOV)  ui->LE_JOINT_LWP->setStyleSheet("background-color: yellow");
    else                                                                ui->LE_JOINT_LWP->setStyleSheet("background-color: white");

    if(PODO_DATA.CoreData.MCStatus[MC_GetID(WST)][MC_GetCH(WST)].b.GOV)      ui->LE_JOINT_WST->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_WST->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RWY2)][MC_GetCH(RWY2)].b.GOV)    ui->LE_JOINT_RWY2->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_RWY2->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RHAND)][MC_GetCH(RHAND)].b.GOV)  ui->LE_JOINT_RHAND->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_RHAND->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LWY2)][MC_GetCH(LWY2)].b.GOV)    ui->LE_JOINT_LWY2->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_LWY2->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LHAND)][MC_GetCH(LHAND)].b.GOV)  ui->LE_JOINT_LHAND->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_LHAND->setStyleSheet("background-color: white");

    if(PODO_DATA.CoreData.MCStatus[MC_GetID(RWH)][MC_GetCH(RWH)].b.GOV)      ui->LE_JOINT_RWH->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_RWH->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(LWH)][MC_GetCH(LWH)].b.GOV)      ui->LE_JOINT_LWH->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_LWH->setStyleSheet("background-color: white");

    if(PODO_DATA.CoreData.MCStatus[MC_GetID(NKP1)][MC_GetCH(NKP1)].b.GOV)    ui->LE_JOINT_NKP1->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_NKP1->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(NKY)][MC_GetCH(NKY)].b.GOV)      ui->LE_JOINT_NKY->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_NKY->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(NKP2)][MC_GetCH(NKP2)].b.GOV)    ui->LE_JOINT_NKP2->setStyleSheet("background-color: yellow");
    else                                                                    ui->LE_JOINT_NKP2->setStyleSheet("background-color: white");
    if(PODO_DATA.CoreData.MCStatus[MC_GetID(NKR)][MC_GetCH(NKR)].b.GOV)      ui->LE_JOINT_NKR->setStyleSheet("background-color: yellow");
