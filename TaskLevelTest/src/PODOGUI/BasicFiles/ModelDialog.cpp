...
enum JointSequentialNumber_Finger{
    RF_a1 = NO_OF_JOINTS-8, RF_a2, RF_a3,
    RF_b1, RF_b2, RF_b3,
    RF_c1, RF_c2, RF_c3,
    LF_a1, LF_a2, LF_a3,
    LF_b1, LF_b2, LF_b3,
...
void ModelDialog::DisplayUpdate(){
    if(ui->CB_USE_ENCODER->isChecked()){
        for(int i = 0; i < NO_OF_JOINTS-8; ++i)
    ...
    glWidget->model->ref[RF_a1+7] = glWidget->model->ref[RF_a2+7] = glWidget->model->ref[RF_a3+7] = ( 100/36.2)*(36.2-JointEncoder(RHAND))*D2Rf;
    glWidget->model->ref[RF_b1+7] = glWidget->model->ref[RF_b2+7] = glWidget->model->ref[RF_b3+7] = ( 100/36.2)*(36.2-JointEncoder(RHAND))*D2Rf;
    glWidget->model->ref[RF_c1+7] = glWidget->model->ref[RF_c2+7] = glWidget->model->ref[RF_c3+7] = (-100/36.2)*(36.2-JointEncoder(RHAND))*D2Rf;

    glWidget->model->ref[LF_a1+7] = glWidget->model->ref[LF_a2+7] = glWidget->model->ref[LF_a3+7] = ( 100/36.2)*(36.2-JointEncoder(LHAND))*D2Rf;
    glWidget->model->ref[LF_b1+7] = glWidget->model->ref[LF_b2+7] = glWidget->model->ref[LF_b3+7] = ( 100/36.2)*(36.2-JointEncoder(LHAND))*D2Rf;
    glWidget->model->ref[LF_c1+7] = glWidget->model->ref[LF_c2+7] = glWidget->model->ref[LF_c3+7] = (-100/36.2)*(36.2-JointEncoder(LHAND))*D2Rf;
...
void GLWidget::paintGL()
{
    ...
    rfforce->setLength(PODO_DATA.CoreData.FT[0].Fz/800.0);
    lfforce->setLength(PODO_DATA.CoreData.FT[1].Fz/800.0);
    rwforce->setLength(PODO_DATA.CoreData.FT[2].Fz/50.0);
    lwforce->setLength(PODO_DATA.CoreData.FT[3].Fz/50.0);

    // wheel----
    rwheel->setLength(rwh_speed);
    isnl::pos rwheelPos = model->getPosition(BRWH);
    ...
    isnl::pos lwheelPos = model->getPosition(BLWH);
...
HUBOModel* GLWidget::newModel(){
    ...
    joints[NKP1]    = new RevoluteYJoint("NKP1");
    joints[NKY]     = new RevoluteZJoint("NKY");
    joints[NKP2]    = new RevoluteYJoint("NKP2");
    joints[NKR]     = new RevoluteXJoint("NKR");
    ...
    *bones[B_WST] + joints[WST] + bones[B_TORSO] + bones[B_CAMERA];
    ...
    tempbone[15] = new Bone("RWFT_RF2_a1", isnl::pos(0.0250,-0.02325,-0.14655));
    tempbone[16] = new Bone("RWFT_RF2_b1", isnl::pos(0.0250, 0.02325,-0.14655));
    tempbone[17] = new Bone("RWFT_RF2_c1", isnl::pos(-0.0250, 0.0000,-0.14655));
    tempbone[21] = new Bone("RF2_a1_a2", isnl::pos(0.0389, 0.0, -0.0389));
    tempbone[22] = new Bone("RF2_b1_b2", isnl::pos(0.0389, 0.0, -0.0389));
    tempbone[23] = new Bone("RF2_c1_c2", isnl::pos(0.0389, 0.0, -0.0389));
    tempbone[24] = new Bone("RF2_a2_a3", isnl::pos(0.04, 0.0, 0.0));
    tempbone[25] = new Bone("RF2_b2_b3", isnl::pos(0.04, 0.0, 0.0));
    tempbone[26] = new Bone("RF2_c2_c3", isnl::pos(0.04, 0.0, 0.0));
    ...
    *bones[B_RWFT] + tempbone[15] + joints[RF_a1] + bones[B_RF_a1] + tempbone[21] + joints[RF_a2] + bones[B_RF_a2] + tempbone[24] + joints[RF_a3] + bones[B_RF_a3];
    *bones[B_RWFT] + tempbone[16] + joints[RF_b1] + bones[B_RF_b1] + tempbone[22] + joints[RF_b2] + bones[B_RF_b2] + tempbone[25] + joints[RF_b3] + bones[B_RF_b3];
    *bones[B_RWFT] + tempbone[17] + joints[RF_c1] + bones[B_RF_c1] + tempbone[23] + joints[RF_c2] + bones[B_RF_c2] + tempbone[26] + joints[RF_c3] + bones[B_RF_c3];
    ...
    tempbone[18] = new Bone("LWFT_LF2_a1", isnl::pos(0.0250,-0.02325,-0.14655));
    tempbone[19] = new Bone("LWFT_LF2_b1", isnl::pos(0.0250, 0.02325,-0.14655));
    tempbone[20] = new Bone("LWFT_LF2_c1", isnl::pos(-0.0250, 0.0000,-0.14655));
    tempbone[27] = new Bone("LF2_a1_a2", isnl::pos(0.0389, 0.0, -0.0389));
    tempbone[28] = new Bone("LF2_b1_b2", isnl::pos(0.0389, 0.0, -0.0389));
    tempbone[29] = new Bone("LF2_c1_c2", isnl::pos(0.0389, 0.0, -0.0389));
    tempbone[30] = new Bone("LF2_a2_a3", isnl::pos(0.04, 0.0, 0.0));
    tempbone[31] = new Bone("LF2_b2_b3", isnl::pos(0.04, 0.0, 0.0));
    tempbone[32] = new Bone("LF2_c2_c3", isnl::pos(0.04, 0.0, 0.0));
    ...
    *bones[B_LWFT] + tempbone[18] + joints[LF_a1] + bones[B_LF_a1] + tempbone[27] + joints[LF_a2] + bones[B_LF_a2] + tempbone[30] + joints[LF_a3] + bones[B_LF_a3];
    *bones[B_LWFT] + tempbone[19] + joints[LF_b1] + bones[B_LF_b1] + tempbone[28] + joints[LF_b2] + bones[B_LF_b2] + tempbone[31] + joints[LF_b3] + bones[B_LF_b3];
    *bones[B_LWFT] + tempbone[20] + joints[LF_c1] + bones[B_LF_c1] + tempbone[29] + joints[LF_c2] + bones[B_LF_c2] + tempbone[32] + joints[LF_c3] + bones[B_LF_c3];
    ...
    *bones[B_WST] + tempbone[10]+joints[LHY] + bones[B_LHY]+joints[LHR] + bones[B_LHR]+ joints[LHP] + bones[B_LHP]
    ...
    tempbone[33] = new Bone("RKN_RWH", isnl::pos(0.04575, -0.08, -0.13));
    tempbone[34] = new Bone("LKN_LWH", isnl::pos(0.04575, 0.08, -0.13));
    *bones[B_RKN] + tempbone[33] + joints[RWH] + bones[B_RWH];
    *bones[B_LKN] + tempbone[34] + joints[LWH] + bones[B_LWH];
    //tree
