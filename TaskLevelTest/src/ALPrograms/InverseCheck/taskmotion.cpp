...
void TaskMotion::RefreshToCurrentReferenceUB()
{
    ...
    kine_drc.FK_RightHand_Local(Q_filt_34x1, LOCAL_UB, pRH_3x1, qRH_4x1, RElb_ang);
    kine_drc.FK_LeftHand_Local(Q_filt_34x1, LOCAL_UB, pLH_3x1, qLH_4x1, LElb_ang);
...
void TaskMotion::RefreshToCurrentReferenceLB(){
    kine_drc.FK_RightFoot_Local(Q_filt_34x1, pRF_3x1, qRF_4x1);
    kine_drc.FK_LeftFoot_Local(Q_filt_34x1,  pLF_3x1, qLF_4x1);
    kine_drc.FK_RightHand_Local(Q_filt_34x1, LOCAL_UB, pRH_3x1, qRH_4x1, RElb_ang);
    kine_drc.FK_LeftHand_Local(Q_filt_34x1, LOCAL_UB, pLH_3x1, qLH_4x1, LElb_ang);
...
void TaskMotion::WBIK_UB(){
    int RH_ref_frame = LOCAL_UB;
    int LH_ref_frame = LOCAL_UB;
    kine_drc.IK_UpperBody_Local(des_pRH_3x1, des_qRH_4x1, des_RElb_ang, RH_ref_frame, des_pLH_3x1, des_qLH_4x1, des_LElb_ang, LH_ref_frame, des_rWST, Qout_34x1);
    ...
    //----------------------------------------
     ...
     kine_drc.FK_RightHand_Local(Q_filt_34x1, RH_ref_frame, pRH_3x1, qRH_4x1, RElb_ang);
     kine_drc.FK_LeftHand_Local(Q_filt_34x1, LH_ref_frame, pLH_3x1, qLH_4x1, LElb_ang);
     kine_drc.FK_RightFoot_Local(Q_filt_34x1, pRF_3x1, qRF_4x1);
     kine_drc.FK_LeftFoot_Local(Q_filt_34x1, pLF_3x1, qLF_4x1);
     kine_drc.FK_COM_Local(Q_filt_34x1, pCOM_2x1);
...
void TaskMotion::WBIK_LB(){

    kine_drc.IK_LowerBody_Local(des_pRF_3x1, des_qRF_4x1, des_pLF_3x1, des_qLF_4x1, Qout_34x1);
    kine_drc.set_Q0(Qout_34x1);
