...
extern double   OnOff_compliance;
extern double   OnOff_zmpcontrol;
extern double   FLAG_leaned;

extern float VelX[2], VelY[2], VelZ[2];
extern float PosX[2], PosY[2], PosZ[2];
extern double ZMPControlX;
extern double ZMPControlY;
