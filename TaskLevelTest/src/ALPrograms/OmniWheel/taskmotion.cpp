...
void TaskMotion::WBIK_PARA_CHANGE(){
    double m_Head = 5;
    double C_Head[3] = {0.0f, 0.0f, 0.15f};

    kine_drc.C_Torso[2] =  ((kine_drc.C_Torso[2]*kine_drc.m_Torso + m_Head*C_Head[2])/(m_Head + kine_drc.m_Torso));
    kine_drc.m_Torso = 24.98723 + m_Head;
}
