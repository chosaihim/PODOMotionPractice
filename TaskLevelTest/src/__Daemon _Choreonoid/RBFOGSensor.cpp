            ...
            while(fog->RBGetReceivedDataByte(&rcv) == 1){
                ...
                case 4:
                    ...
                    if(cnt == 32){
                        ...
                        sharedData->FOG.RollVel  = delX;
                        sharedData->FOG.PitchVel = delY;
                        sharedData->FOG.YawVel   = delZ;
                        ...
                        sharedData->FOG.Roll = fog->FOGRoll;
                        sharedData->FOG.Pitch = fog->FOGPitch;
                        sharedData->FOG.Yaw = fog->FOGYaw;
