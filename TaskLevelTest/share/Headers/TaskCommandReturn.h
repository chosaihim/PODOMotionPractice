...
typedef enum{
    ...
    TCMD_VALVE_BACKMODE_POS_CHANGE_DONE,
    TCMD_VALVE_BACKMODE_APPROACH_DONE,
    // Door     [400~499]
    TCMD_DOOR_GO = 400,
    TCMD_DOOR_GO_NEARGO,
    TCMD_DOOR_OPEN,
    ...
    TCMD_PUSHDOOR_MOTION_2_NOPROBLEM,
    // Hose     [500~599]
    ...
    TCMD_DRILL_PUNCH_DONE,
    TCMD_DRILL_BACKMODE_POS_CHANGE_DONE,
    TCMD_DRILL_BACKMODE_APPROACH_DONE,
